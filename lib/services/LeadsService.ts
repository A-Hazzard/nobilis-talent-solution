  ...
  async getAll(options: {
    ...
    try {
      ...
      let leads: Lead[] = snapshot.docs.map(doc => ({
        ...
        primaryGoals: doc.data().primaryGoals || [],
        organizationType: doc.data().organizationType || undefined,
        industryFocus: doc.data().industryFocus || undefined,
        teamSize: doc.data().teamSize || undefined,
        challengesDescription: doc.data().challengesDescription || undefined,
        timeline: doc.data().timeline || undefined,
        budget: doc.data().budget || undefined,
        uid: doc.data().uid || '',
